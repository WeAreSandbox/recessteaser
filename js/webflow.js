...
Webflow.require('ix').init([
  {"slug":"logo","name":"logo","value":{"style":{"opacity":0,"x":"0px","y":"-14px"},"triggers":[{"type":"load","stepsA":[{"opacity":1,"transition":"transform 1000ms ease-out 0ms, opacity 1200ms ease-out 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  {"slug":"form","name":"form","value":{"style":{"opacity":0},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":1,"transition":"opacity 1200ms ease-out 0ms"}],"stepsB":[]}]}}
]);
